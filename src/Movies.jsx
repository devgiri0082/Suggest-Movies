...
export default function Movies(props) {
    ...
    let url = `https://api.themoviedb.org/3/movie/${location.state.id}?api_key=4bcfe4d5b96cbe94853cacb35fd2b4cd&language=en-US&append_to_response=videos`;
    ...
    if(!loading) {
            return (
            <div className="container-1" style={{backgroundImage: `linear-gradient(
            rgba(0, 0, 0, 0.4), 
            rgba(0, 0, 0, 0.4)
